...
class DesktopAppOpener implements AppOpener {
  private openAppFn?: (name: string, props?: any) => Promise<void> | void;
...
// Factory
export function createAppOpener(mobileOpener?: (name: string, props?: any) => void): AppOpener {
  return mobileOpener ? new MobileAppOpener(mobileOpener) : new DesktopAppOpener();
}